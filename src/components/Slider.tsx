...
const Slider = () => {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-6rem)] md:h-[calc(100vh-9rem)] lg:flex-row bg-fuchsia-50">
      ...
      <div className="w-full flex-1 relative h-[calc(100vh-6rem)] md:h-[calc(100vh-9rem)]">
        <Image src={data[currentSlide].image} alt="" fill className="object-cover" sizes="60vw" />
      </div>
    </div>
  );
};
